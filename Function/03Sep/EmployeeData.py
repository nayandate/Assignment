...
print("Employee Ages:")
e_age = list(map(int,input().split()))
print()
...
====================================================""")
    ...
    match ch:
        case 1:
            ans = secondHighest(*e_age)
            print("Second Highest Age :",ans)

        case 2:
            ans = seniorEmp(*e_age)
            print("Senior Employees :",ans)

        case 3:
            ans = uniqueAge(*e_age)
            print("Unique Ages :",ans)

        case 4:
            ans = checkVowel(*e_name)
            print("Names Starting with Vowel :",ans)
        case 5:
            ans = longestName(*e_name)
            print("Longest Employee Name :",ans)
