...
if u1 > u2:
     if u1>u3:
          if u1>u4:
              if u1>u5:
                  if u1>u6:
                      print("Highest Stock (u1) = ",u1)
                  else:
                      print("Highest Stock (u6) = ",u6)
              else:
                  if u5>u6 :
                      print("Highest Stock (u5) = ",u5)
                  else:
                      print("Highest Stock (u6) = ",u6)
          else :
              if u4>u5 :
                    if u4>u6:
                      print("Highest Stock (u4) = ",u4)
                    else:
                      print("Highest Stock (u6) = ",u6)
              else:
                    if u5>u6:
