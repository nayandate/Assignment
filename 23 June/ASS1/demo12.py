...
if bill<=100:
     print("Final Bill Amount: ₹",(bill*5//100)+bill)
elif bill<=5000:
     if bill<=3000:
         print("Final Bill Amount: ₹",(bill*12//100)+bill)
     else:
         print("Final Bill Amount: ₹",(bill*12//100+200)+bill)
else:
     print("Final Bill Amount: ₹",(bill*18//100+200)+bill)