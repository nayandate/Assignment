...
while True:
    ...
    print("Press 2 to Subtract Two Matrices")
    print("Press 3 to compare Two Matrices")
            ...
            if row1 == row2 and column1 == column2:
                ...
                for i in range(row2):
                    ...
                    for j in range(column2):
                        row.append(int(input("Enter elements for matrix2: ")))
                    matrix2.append(row)
                print("\nMatrix 2:",matrix2)
                ...
                print("\nMatrix after addition is:",matrix)
            else:
        ...
        case 2:
            ...
            if row1 == row2 and column1 == column2:
                ...
                for i in range(row1):
                    for j in range(column1):
                        matrix[i][j] = matrix1[i][j]-matrix2[i][j]
                print("\nMatrix after subtraction is:",matrix)
            else:
                print("Operation can not be performed") 
        case 4:
